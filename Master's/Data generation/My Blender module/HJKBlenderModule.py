...
def add_particlesV2(surface_obj, obj_name="", type="hair"):
    ...
    foreign-obj:
        ...
        - Spawns it once in a random size, position and orientation on surface_obj.
    dirt:
        ...
        - Spawns it 0-100000000 times at random sizes, positions and orientations on surface_obj.
    hair:
        - Changes the colour of the hair material.
        - Spawns a random number of hair strands on the surface_obj with a random waviness and size.
    '''
    if type == "foreign-obj":
